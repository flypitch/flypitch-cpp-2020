...
%This is a unconventional way to define terms, which we chose because of the limited support for nested inductive types in Lean, though recent progress~\cite{avigad2019datattypes} might add better support in the future.
