...
\begin{lemma}\label{lemma-function-reflect-suffices}
  Let \(\mathbb{B}\) be a complete Boolean algebra, and suppose that for every \lil{ y : pSet}, and every \lil{f : bSet 𝔹} such that \lil{bSet 𝔹} models that \lil{f} is a function from \(\omega\) to \(\check{y}\), there exists a \lil{g : pSet} such that \lil{g} is a function from \(\omega\) to \lil{y} in \lil{pSet}, and \lil{bSet 𝔹} models that \(\check{g} = f\). Then \(\check{\mathcal{P}(\omega)} = \mathcal{P}(\omega)\) and \(\check{\aleph_1} = \aleph_1\).
\end{lemma}
...
\begin{lemma}\label{lemma-function-reflect}
  For every \lil{ y : pSet}, and every \lil{f : bSet 𝔹_collapse} such that \lil{bSet 𝔹_collapse} models that \lil{f} is a function from \(\omega\) to \(\check{y}\), there exists a \lil{g : pSet} such that \lil{g} is a function from \(\omega\) to \lil{y} in \lil{pSet}, and \lil{bSet 𝔹_collapse} models that \(\check{g} = f\).
\end{lemma}
