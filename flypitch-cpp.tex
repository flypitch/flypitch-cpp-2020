...
\documentclass[sigplan,10pt,review]{acmart} % add: anonymous
...
\section{Collapsing poset}
\label{section:collapsing}

\section{The independence of CH}
\label{section:independence-CH}
