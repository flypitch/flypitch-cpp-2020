...
The conventional accounts of forcing work with a poset \(\mathbb{P}\) over a countable transitive model \cite{kunen2014set, jech2013set}, and use a generic filter to ``evaluate'' the \lstinline{ℙ}-names and produce an ordinary model of \(\ZFC\).
Instead, we force with \emph{Boolean-valued models} of \(\ZFC\) instead.
